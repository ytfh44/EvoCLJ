...
;; ---------------------------------------------------------------------------
;; GC-22 metadata safety for promotion events is now enforced by the store's
;; single write path (evoclj.store.event/append-event-on-conn!) and covered by
;; evoclj.store.event-test at that boundary — promotion no longer carries a
;; second EDN-safety checker of its own.
;; ---------------------------------------------------------------------------
